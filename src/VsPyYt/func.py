...
async def tint_art_m(websocket, r, g, b, a, tintall, num, exactarray, conarray, tagexactarray, tagconarray):
    payload = {
        "apiName": "VTubeStudioPublicAPI",
        "apiVersion": v,
        "requestID": reqid,
...
async def spin(websocket,x,y,s):
    for i in range(1, 5):
        await mdmv(websocket, 0.2, False, x, y, i * 90, s)
        time.sleep(0.1)

async def rainbow(websocket):
    await tint_art_m(websocket, 255, 0, 0, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 255, 127, 0, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 255, 255, 0, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 0, 255, 0, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 0, 0, 255, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 46, 43, 95, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 139, 0, 255, 255, True, "", "", "", "", "")
    time.sleep(0.2)
    await tint_art_m(websocket, 255, 255, 255, 255, True, "", "", "", "", "")